...
import {onReplaceCategoryDescription} from "@/actions/category";
...
const formSchema = z.object({
  description: z.string().min(2).max(500, {
    message: "Category name must be less than 500 characters",
  }),
});
...
function CategoryDescription({description}: Props) {
